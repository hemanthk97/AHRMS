    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                getvaluepersonaldetails(uniqueid);
        ...
        protected void TextBox1_TextChanged1(object sender, EventArgs e)
        {
            lblviewdelsuccessstate.Text = "";
             ...
             if (getstatusnumberorchar(TextBox1.Text))
             {
                 ...
                 bool datavailable = checkdataavailable(uniq, "checkuiexp");
                 if (datavailable)
                 {
                     ...
                     empdesg.Text = deg;
                     addexpfrdate.Text = frdate;
                     addexpenddate.Text = todate;
                     addexpskills.Text = skill;
                     ratingvalue.Text =  rating;
                     if (Convert.ToDouble(rating) < 2.5)
                     {
                         ratingvalue.ForeColor = System.Drawing.Color.Red;
                     }
                     else if (Convert.ToDouble(rating) > 2.5 && Convert.ToDouble(rating) < 4)
                     {
                     ...
                     addexpcomm.Text = comm;
                     lblviewdelsuccessstate.Text = "Below is the Experience details of   ";
                     nameuser.Text = username;
                 }
                 else
                 {
                     lblviewdelsuccessstate.Text = "Experience Not Available";
                 }
             }
             else
             {
