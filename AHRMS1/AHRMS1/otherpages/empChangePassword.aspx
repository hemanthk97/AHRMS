<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="empChangePassword.aspx.cs" Inherits="AHRMS1.otherpages.empChangePassword" %>
    ...
    <div>
         ...
         <span style="position:fixed" class="hvr-buzz-out">
            <input class="logosize" type="image" alt="AHRMS" src="../Images/logo.png"/></span>
             <p id="headernote" style="text-align:center;color:white">Employer Advance Human Resource Management System </p>
       ...
       <p class="aa" id="at">A</p>
        ...
        <p style="font-size:x-large;font-weight:800">Create your password</p>
            <br />
       ...
       <div style="padding-top:1em">  </div>
        ...
        <asp:Label ID="lblcnpas" runat="server"  Text=""></asp:Label><br />
                   <br />
            <br /><asp:HyperLink ID="HyperLink1" Visible="false" NavigateUrl="~/hrae/hrlogreg.aspx" ForeColor="Black" runat="server">Click here to login</asp:HyperLink>
    </div>
        </div>
    </form>
</body>
